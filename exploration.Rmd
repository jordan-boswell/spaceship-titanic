...
updateSpending <- function(){
  ship$Spending <- ifelse(is.na(ship$RoomService), 0, ship$RoomService) + ifelse(is.na(ship$FoodCourt), 0, ship$FoodCourt) + ifelse(is.na(ship$ShoppingMall), 0, ship$ShoppingMall) + ifelse(is.na(ship$Spa), 0, ship$Spa) + ifelse(is.na(ship$VRDeck), 0, ship$VRDeck)
  ship$HasSpent <- ship$Spending > 0
}
```
...
### Evidence
```{r}
spending <- ifelse(is.na(ship$RoomService), 0, ship$RoomService) + ifelse(is.na(ship$FoodCourt), 0, ship$FoodCourt) + ifelse(is.na(ship$ShoppingMall), 0, ship$ShoppingMall) + ifelse(is.na(ship$Spa), 0, ship$Spa) + ifelse(is.na(ship$VRDeck), 0, ship$VRDeck)
for (age in 1:15){
