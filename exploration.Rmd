...
plot(names(spending_mean), spending_mean, main='Spending by Age', xlab='Age', ylab='Spending', col='red', type='l', lwd=2, ylim=c(0, max(spending_75)))
lines(names(spending_mean), spending_25, col='light blue', lwd=2)
lines(names(spending_mean), spending_75, col='dark blue', lwd=2)
legend(x='topleft', legend=c('25th percentile', 'mean', '75th percentile'), col=c('light blue', 'red', 'dark blue'), lwd=2)
```
### Update
```{r}
